...
import HomePage from "../main/views/home-page";
import PrayerTImes from "../main/views/prayer-time"
import IslamPillars from "../main/views/islam-pillars"
...
export default createModule(({ use }) => {
  ...
  useComponent("home-page", HomePage)
  useComponent("prayer-times", PrayerTImes);
  useComponent("islam-pillars",IslamPillars);
